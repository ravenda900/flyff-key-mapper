...
const usage = () => {
  console.error(
    [
      "Usage:",
      "  node scripts/set-firebase-claims.mjs --uid <firebase-uid> --role <user|admin|superadmin> [--ip <public-ip>]",
      "",
      "Examples:",
      "  node scripts/set-firebase-claims.mjs --uid abc123 --role admin",
      "  node scripts/set-firebase-claims.mjs --uid abc123 --role superadmin --ip 203.0.113.10",
    ].join("\n"),
  );
};
